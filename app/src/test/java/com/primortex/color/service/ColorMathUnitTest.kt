...
class ColorMathUnitTest {
    ...
    @Test
    fun recommendedOnColorUsesExpectedThreshold() {
        assertEquals(0xFFFFFFFF.toInt(), recommendedOnColor(0xFF000000.toInt()))
        assertEquals(0xFF000000.toInt(), recommendedOnColor(0xFFFFFFFF.toInt()))
    }

    @Test
    fun hueShiftRotatesHueAndWrapsForPositiveAndNegativeDegrees() {
        ...
        val shiftedNegative = hueShift(0xFFFF0000.toInt(), -120f)
        assertEquals(0xFF0000FF.toInt(), shiftedNegative)
    }
